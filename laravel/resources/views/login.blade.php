<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from html.nioboard.themenio.com/auths/auth-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Jun 2023 12:27:48 GMT -->
...
<head>
    ...
    <title>Auth Login - NioBoard Responsive Admin Dashboard Template</title>
                        ...
                        <div class="row g-0 flex-lg-row-reverse">
                            <div class="col-lg-5">
                                <div class="card-body h-100 d-flex flex-column justify-content-center">
                                    ...
                                    <form action="{{url('/doLogin')}}" method="post">
                                        ...
                                        <div class="row gy-3">
                                            <div class="col-12">
                                                <div class="form-group"><label for="email" class="form-label">Email or
                                                        Username</label>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group"><label for="password"
                                                    ...
                                                    <div class="form-control-wrap"><input name='password' type="password"
                            ...
                            <div class="col-lg-7">
                                <div
                                    ...
                                    <div class="brand-logo"><a href="../index.html" class="logo-link">
                                            <div class="logo-wrap"><svg class="logo-svg" viewBox="0 0 174 34"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-11">
                                            <div class="mt-4">
                                                <div class="h1 title mb-3">Welcome back to <br> profile matching laravel</div>
                                                <p>judul</p>
                                            </div>
                                        </div>
                                    </div>
